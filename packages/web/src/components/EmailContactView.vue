...
<template>
  <div :class="['email-view', theme.containerClass]">
    ...
    <div class="email-header">
      <button class="back-btn" :disabled="isLoading" @click="goBack">
    ...
    <div class="email-content">
      <form class="email-form" @submit.prevent="sendEmail">
        ...
        <div class="form-actions">
          <button type="button" class="btn-cancel" :disabled="isLoading" @click="goBack">
            Cancel
          </button>
      ...
      <div v-if="showSuccess" class="message success-message">
        ...
        <div class="message-content">
          ...
          <button :class="['btn-return', theme.sectionStyle]" @click="goBack">
            Return to Portfolio
          </button>
        </div>
      </div>
      ...
      <div v-if="showError" class="message error-message">
        ...
        <div class="message-content">
          ...
          <p>{{ errorMessage }}</p>
          <button :class="['btn-retry', theme.sectionStyle]" @click="resetForm">
            Try Again
          </button>
        </div>
      </div>
...
const _MIN_RECAPTCHA_SCORE = 0.3 // eslint-disable-line no-unused-vars
